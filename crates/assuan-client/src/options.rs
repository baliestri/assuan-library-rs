...
pub struct ClientOptions {
  /// Maximum duration of one inquiry, subordinate to the enclosing deadline; defaults to 120 seconds.
  pub inquiry_timeout: Duration,
  /// Maximum decoded bytes sent per inquiry; defaults to one MiB and must be positive.
